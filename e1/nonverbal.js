...
function loadImage(name) {
  ...
  images[name].src = "images/" + name + ".png"; // image's folder
}
...
function redraw() {
  ...
  if (jumping) {
	...
	context.drawImage(images["leftArm"], x + 40, y - 2 - breathAmt);
  }
  ...
  if (jumping) {
	...
	context.drawImage(images["rightArm"], x + 55, y - 42 - breathAmt);
  }
